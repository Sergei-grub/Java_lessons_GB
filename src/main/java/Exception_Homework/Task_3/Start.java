...
import Exception_Homework.Task_3.Controller.AddUser;
    ...
    public static void main(String[] args) throws NumDataException, InputMismatchException {
        ...
        while (isExit == 1) {
            ...
            if (Objects.equals(userInput, "1")) {
                System.out.println("Введите данные пользователя, указав фамилию, имя, отчество, дату рождения, телефон (до 7 знаков) и пол (m или f): ");
                user.addUser();
            }
